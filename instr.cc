/* Honeywell Series 16 emulator $Id: instr.cc,v 1.6 2001/06/09 22:12:02 adrian Exp $
 ...
 *
 * $Log: instr.cc,v $
 * Revision 1.6  2001/06/09 22:12:02  adrian
 * Various bug fixes
 *
 * Revision 1.5  2000/01/15 06:26:17  adrian
 * Generic shift and group A instructions
 *
 * Revision 1.4  1999/09/01 06:36:08  adrian
 * Minor change to make Proc::do_XXX calls conditional for slst.cc
 *
